package com.amazonaws.apachebeam.jackson;
...
public interface JacksonConverter {
     ...
     * @throws JacksonConverterException Error converting DynamoDB item to JSON
     */
     ...
     * @throws JacksonConverterException if JsonNode is not an array
     */
     ...
     * @throws JacksonConverterException if JsonNode is not an object.
     */
